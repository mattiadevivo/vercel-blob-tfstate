...
import { LockConflictError, LockMismatchError, StateNotFoundError } from "../../../src/domain/errors";
...
describe("StateService", () => {
    ...
    describe("getState", () => {
        ...
        test("should raise StateNotFoundError if state is not found", async () => {
            stateStoreMock.get.mockResolvedValue(undefined);
    ...
    describe("releaseLock", () => {
        ...
        test("should force release lock if lockInfo is undefined", async () => {
            await service.releaseLock("test", undefined);
    ...
    describe("updateState", () => {
        test("should update state successfully without lock", async () => {
            await service.updateState("test", "new state", undefined);
        ...
        test("should raise LockMismatchError if lock ID does not match", async () => {
            ...
            await expect(service.updateState("test", "new state", lockInfo.ID)).rejects.toThrow(LockMismatchError);
